...
\setsansfont[Mapping=tex-text,
	Ligatures={Common},
	Colour=ImperialBlue]{Unit-Medium}
\setmonofont[Mapping=tex-text,Scale=0.72]{Pragmata Pro}
...
\newcommand{\amper}{{\fontspec[Scale=.95,Colour=ImperialBlue]{Minion Pro Medium}\selectfont\&\,}}
